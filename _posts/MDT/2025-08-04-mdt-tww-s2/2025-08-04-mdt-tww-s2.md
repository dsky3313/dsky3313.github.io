...
categories:
  - MDT
tags: [MDT]
description: 내부전쟁 2시즌 MDT 쐐기 루트
toc: true
image:
  path: tww-s2.jpg
media_subpath: /_posts/MDT/2025-08-04-mdt-tww-s2/
---
...
```  
> <img src="https://wow.zamimg.com/images/wow/icons/large/spell_nature_bloodlust.jpg" style="height:1em; vertical-align:middle;">{: .normal } **블러드** : 입구 ▶ 7번 (1넴 뒤) ▶ 15번 (막넴 앞 중보)
{: .prompt-danger }
입구블 후 넴드블 하셔도 됩니다.  
저 - 중단용 루트입니다.  
...
{% include embed/youtube.html id="hT72YIrxurg" %}  
플레이 영상 : 15단 수도원 - 전탱
<br>
...
```  
> <img src="https://wow.zamimg.com/images/wow/icons/large/spell_nature_bloodlust.jpg" style="height:1em; vertical-align:middle;">{: .normal } **블러드** : 입구 ▶ 2넴 혹은 3넴 ▶ 막넴
{: .prompt-danger }
1넴 후, 취향껏 이파나 버즈비에서 넴드블 하시면 됩니다.  
부담되시면 무리하게 풀링하기보단 나눠서 가다가 체인풀 하시면 됩니다.  
<br>

{% include embed/youtube.html id="JDEh70daEag" %}  
플레이 영상 : 15단 양조장 - 전탱
<br>
...
> <img src="https://wow.zamimg.com/images/wow/icons/large/spell_nature_bloodlust.jpg" style="height:1em; vertical-align:middle;">{: .normal } **블러드** : 입구 ▶ 7번 ▶ 3넴 버즈비
{: .prompt-danger }
6번 풀링 후, 쫄을 구석으로 끌고들어가서 7번 풀 로머 위치 조심하며  
파티원들을 먼저 보내고 그숨패스 하시면 됩니다.  
<br>

{% include embed/youtube.html id="QiifmPxWuQ8" %}  
플레이 영상 : 16단 양조장 - 전탱
<br>
<br>
<br>
...
```  
> <img src="https://wow.zamimg.com/images/wow/icons/large/spell_nature_bloodlust.jpg" style="height:1em; vertical-align:middle;">{: .normal } **블러드** : 입구 ▶ 3넴 ▶ 막넴
{: .prompt-danger }
...
{% include embed/youtube.html id="Rv81SAODCkE" %}  
플레이 영상 : 16단 어불동 - 전탱
<br>
<br>
<br>
...
```  
> <img src="https://wow.zamimg.com/images/wow/icons/large/spell_nature_bloodlust.jpg" style="height:1em; vertical-align:middle;">{: .normal } **블러드** : 입구 ▶ 1넴 큰대모 ▶ 막넴
{: .prompt-danger }
...
> <img src="https://wow.zamimg.com/images/wow/icons/large/spell_nature_bloodlust.jpg" style="height:1em; vertical-align:middle;">{: .normal } **블러드** : 입구 ▶ 1넴 큰대모 ▶ 막넴
{: .prompt-danger }
> <img src="https://wow.zamimg.com/images/wow/icons/large/ability_ambush.jpg" style="height:1em; vertical-align:middle;">{: .normal } **패스** : 1넴 뒤 박스, 14번 앞 방울이, 막넴앞 시동자 2 마리  
{: .prompt-tip }
<br>
...
```  
> <img src="https://wow.zamimg.com/images/wow/icons/large/spell_nature_bloodlust.jpg" style="height:1em; vertical-align:middle;">{: .normal } **블러드** : 입구 ▶ 2넴 ▶ 막넴 or 막넴 앞 전쟁기계 2마리
{: .prompt-danger }
입구블 후, 벽 넘어 가는 루트입니다.  
...
> <img src="https://wow.zamimg.com/images/wow/icons/large/spell_nature_bloodlust.jpg" style="height:1em; vertical-align:middle;">{: .normal } **블러드** : 1넴 ▶ 2넴 ▶ 막넴
{: .prompt-danger }
> <img src="https://wow.zamimg.com/images/wow/icons/large/ability_ambush.jpg" style="height:1em; vertical-align:middle;">{: .normal } **패스** : 1넴 앞, 3넴 앞, 막넴 앞  
{: .prompt-tip }
1넴 앞은 `위협의외침` - `위협` 특성을 찍고 왼쪽무리에 공포를 넣은 다음 1넴 앞 3마리를 끌고 들어가 그숨으로 패스했습니다
<br>

{% include embed/youtube.html id="0UJkLhv63xw" %}  
플레이 영상 : 16단 왕노 - 전탱
<br>
<br>
<br>
...
```  
> <img src="https://wow.zamimg.com/images/wow/icons/large/spell_nature_bloodlust.jpg" style="height:1em; vertical-align:middle;">{: .normal } **블러드** : 입구 ▶ 2넴 ▶ 막넴
{: .prompt-danger }
평범하게 직진하는 루트.  
<br>
...
> <img src="https://wow.zamimg.com/images/wow/icons/large/spell_nature_bloodlust.jpg" style="height:1em; vertical-align:middle;">{: .normal } **블러드** : 입구 ▶ 9번 (2넴 앞) ▶ 막넴
{: .prompt-danger }
11번풀 후, 양산을 사용하는 루트입니다.  
2넴 잡을 때, 자고있는 쫄 하나를 깨워서 붙여주세요.  
<br>

{% include embed/youtube.html id="w18TbzAhn9M" %}  
플레이 영상 : 16단 부화장 - 전탱
<br>
<br>
<br>
...
```  
> <img src="https://wow.zamimg.com/images/wow/icons/large/spell_nature_bloodlust.jpg" style="height:1em; vertical-align:middle;">{: .normal } **블러드** : 입구 ▶ 2넴 선혈토막 ▶ 막넴
{: .prompt-danger }
쭉 직진하는 루트.  
<br>
...
```  
> <img src="https://wow.zamimg.com/images/wow/icons/large/spell_nature_bloodlust.jpg" style="height:1em; vertical-align:middle;">{: .normal } **블러드** : 1넴 ▶ 3넴 ▶ 막넴 2페
{: .prompt-danger }
쭉 직진하는 루트.  
...
> <img src="https://wow.zamimg.com/images/wow/icons/large/spell_nature_bloodlust.jpg" style="height:1em; vertical-align:middle;">{: .normal } **블러드** : 입구 ▶ 3넴 ▶ 막넴 2페
{: .prompt-danger }
2넴 잡고 똥개 애드나지 않게 벽에 딱 붙어 올라가세요.  
도적(도비), 사제(위안), 흑마(관문)이 있다면 12번 패스하세요.  
<br>

{% include embed/youtube.html id="TyA_I-WhHNk" %}  
플레이 영상 : 16단 수도원 - 전탱
<br>
<br>