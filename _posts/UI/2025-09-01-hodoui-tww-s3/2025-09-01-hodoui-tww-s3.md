...
toc_label: hodoUI
header:
  teaser: "/_posts/UI/2025-09-01-hodoui-tww-s3/2.webp"
---
...
![이미지 설명](/_posts/UI/2025-09-01-hodoui-tww-s3/install1.webp)  
<span style="color:#26beff">[2]</span> `Font`, `Interface` 폴더는 와우 설치폴더 (Program Files\World of Warcraft\_retail_) 에 붙여넣기.
<br>

![이미지 설명](/_posts/UI/2025-09-01-hodoui-tww-s3/install2.webp)  
...
![이미지 설명](/_posts/UI/2025-09-01-hodoui-tww-s3/1.webp)
![이미지 설명](/_posts/UI/2025-09-01-hodoui-tww-s3/2.webp)
```  
